<form id="picklistPanel">
    <div class="contentLabel">FOR PICKLIST : </div>
    ...
    <div class="contentControl"><input id="txtPickListName" name="txtPickListName" type="text" required/></div>
    <div class="contentBreak"></div>

    <div class="contentLabel">Pick list argument(should be comma separated) : </div>
    <div class="contentControl"><textarea id="txtPickListContent" name="txtPickListContent" type="text" required></textarea></div>
    <div class="contentBreak"></div>
    ...
    <div class="contentControl"><input id="savepicklist" name="savepicklist" type='submit' value='Save'/></div>
    <div class="contentBreak"></div>
</form>
<form id="textareaPanel">
    <div class="contentLabel">FOR TEXT AREA : </div>
    ...
    <div class="contentControl"><input id="txtTextAreaName" name="txtTextAreaName" type="text" required/></div>
    <div class="contentBreak"></div>

    <div class="contentLabel">&nbsp;</div>
    <div class="contentControl"><input id="savetextarea" name="savetextarea" type='submit' value='Save'/></div>
    <div class="contentBreak"></div>
</form>
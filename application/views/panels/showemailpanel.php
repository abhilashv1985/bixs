<form id="emailPanel">
    <div class="contentLabel">FOR EMAIL : </div>
    ...
    <div class="contentControl"><input id="txtEmailName" name="txtEmailName" type="text" required/></div>
    <div class="contentBreak"></div>

    <div class="contentLabel">&nbsp;</div>
    <div class="contentControl"><input id="saveEmail" name="saveEmail" type='submit' value='Save'/></div>
    <div class="contentBreak"></div>
</form>
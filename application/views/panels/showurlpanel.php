<form id="urlPanel">
    <div class="contentLabel">FOR URL : </div>
    ...
    <div class="contentControl"><input id="txtUrlName" name="txtUrlName" type="text" required/></div>
    <div class="contentBreak"></div>

    <div class="contentLabel">Field Length : </div>
    <div class="contentControl"><input id="txtUrlLength" name="txtUrlLength" type="number"  required/></div>
    <div class="contentBreak"></div>

    <div class="contentLabel">&nbsp;</div>
    <div class="contentControl"><input id="saveurl" name="saveurl" type='submit' value='Save'/></div>
    <div class="contentBreak"></div>
</form>
<form id="datePanel">
    <div class="contentLabel">FOR DATE : </div>
    ...
    <div class="contentControl"><input id="txtDateName" name="txtDateName" type="text" required/></div>
    <div class="contentBreak"></div>

    <div class="contentLabel">&nbsp;</div>
    <div class="contentControl"><input id="saveDate" name="saveDate" type='submit' value='Save'/></div>
    <div class="contentBreak"></div>
</form>